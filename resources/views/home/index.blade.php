...
@section('content')
    ...
    <section class="content content-custom no-print">
        ...
        @if (auth()->user()->can('dashboard.data'))
            @if ($is_admin)
                <div class="row">
                    <div class="col-md-4 col-xs-12" style="background-color: transparent !important;">
                ...
                <div class="row row-custom">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" style="background-color: #A05AFF;">
                            <span class="info-box-icon" style="background-color: #fff;"><i class="ion ion-ios-cart-outline"
                                    style="color: #000; font-weight:700;"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text" style="color: #fff;">{{ __('home.total_sell') }}</span>
                                <span class="info-box-number total_sell" style="color: #fff;"><i
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" style="background-color: #1BCFB4;">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text" style="color: #fff;">{{ __('lang_v1.net') }}
                                    @show_tooltip(__('lang_v1.net_home_tooltip'))</span>
                                <span class="info-box-number net" style="color: #fff;"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" style="background-color: #4BCBEB;">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number invoice_due" style="color: #fff;"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        ...
                        <div class="info-box info-box-new-style" style="background-color: #FE9496;">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"
                                    style="color: #fff;">{{ __('lang_v1.total_sell_return') }}</span>
                                <span class="info-box-number total_sell_return" style="color: #fff;"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                ...
                <div class="row row-custom">
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" style="background-color: #A05AFF;">
                            <span class="info-box-icon" style="background-color: #fff;"><i class="ion ion-cash"
                                    style="color: #000; font-weight:700;"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text" style="color: #fff;">{{ __('home.total_purchase') }}</span>
                                <span class="info-box-number total_purchase" style="color: #fff;"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" style="background-color: #1BCFB4;">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number purchase_due" style="color: #fff;"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" style="background-color: #4BCBEB;">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text"
                                    style="color: #fff;">{{ __('lang_v1.total_purchase_return') }}</span>
                                <span class="info-box-number total_purchase_return" style="color: #fff;"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" style="background-color: #FE9496;">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number total_expense" style="color: #fff;"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
