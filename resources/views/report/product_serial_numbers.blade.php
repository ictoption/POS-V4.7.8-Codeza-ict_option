...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-2">{!! Form::label('location_id', 'Location:') !!}{!! Form::select('location_id', $locations, request('location_id'), ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')]) !!}</div>
        <div class="col-md-2">{!! Form::label('status', 'Status:') !!}{!! Form::select('status', ['available' => 'Available', 'sold' => 'Sold', 'damaged' => 'Damaged'], request('status'), ['class' => 'form-control', 'placeholder' => 'All']) !!}</div>
    ...
    <div class="row">
        ...
        <div class="col-md-3"><div class="small-box bg-yellow"><div class="inner"><h3>{{$summary['damaged']}}</h3><p>Damaged Serial Numbers</p></div></div></div>
    </div>

    @component('components.widget', ['class' => 'box-primary'])
    <table class="table table-bordered table-striped">
        <thead><tr><th>#</th><th>Product</th><th>Location</th><th>Serial Number</th><th>Status</th><th>Sold Invoice</th><th>Sold At</th></tr></thead>
        <tbody>
